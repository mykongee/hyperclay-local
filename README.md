...
1. **Download** the app for your platform:
   - **macOS (Apple Silicon)**: [HyperclayLocal-1.8.1-arm64.dmg](https://local.hyperclay.com/HyperclayLocal-1.8.1-arm64.dmg) (100.7MB)
   - **macOS (Intel)**: [HyperclayLocal-1.8.1.dmg](https://local.hyperclay.com/HyperclayLocal-1.8.1.dmg) (108.4MB)
   - **Windows**: [HyperclayLocal-Setup-1.8.1.exe](https://local.hyperclay.com/HyperclayLocal-Setup-1.8.1.exe) (~81.3MB)
   - **Linux**: [HyperclayLocal-1.8.1.AppImage](https://local.hyperclay.com/HyperclayLocal-1.8.1.AppImage) (119.0MB)
